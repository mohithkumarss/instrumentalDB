...
<section class="product-search text-center">
    <div class="container">
        ...
        <h2>Products on <a href="#" class="">"<?php echo $category_title; ?>"</a></h2>
...
<section class="product-menu">
    <div class="container">
        ...
        <?php 
            ...
            $sql2 = "SELECT * FROM t_product WHERE category_id=$category_id";
                ...
                while($row2=mysqli_fetch_assoc($res2))
                {
                    ...
                    <div class="product-menu-box">
                        ...
                        <div class="product-menu-desc">
                            ...
                            <a href="<?php echo URL; ?>order.php?product_id=<?php echo $id; ?>" >Order Now</a>
                        </div>
                    </div>
