                        ...
                        if($count>0)
                        {
                            ...
                            while($row=mysqli_fetch_assoc($res))
                            {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php  
                                            ...
                                            else
                                            {
                                                ...
                                                ?>
                                                <img src="<?php echo URL; ?>images/product/<?php echo $image_name; ?>" width="100px">
                                                <?php
                                            }
                                        ?>
                                    </td>
                                    ...
                                    <td>
                                        <a href="<?php echo URL; ?>admin/update-product.php?id=<?php echo $id; ?>" class="btn-secondary">Update Product</a>
                                        <a href="<?php echo URL; ?>admin/delete-product.php?id=<?php echo $id; ?>&image_name=<?php echo $image_name; ?>" class="btn-danger">Delete product</a>
                                    </td>
                                </tr>
