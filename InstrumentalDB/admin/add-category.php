        ...
        if (isset($_POST['submit'])) {
            ...
            if (isset($_FILES['image']['name'])) {
                ...
                if ($image_name != "") {
                    ...
                    //Rename the Image
                    $image_name = "instrument_Category" . rand(000, 999) . '.' . $ext; // e.g. Food_Category_834.jpg
            ...
            if ($res == true) {
                ...
                echo $_SESSION['add'] = "<div class='success'>Category Added Successfully.</div>";
                //Redirect to Manage Category Page
                header('location:' . URL . 'admin/manage-category.php');
            } else {
                //Failed to Add CAtegory
                echo $_SESSION['add'] = "<div class='error'>Failed to Add Category.</div>";
                //Redirect to Manage Category Page
                header('location:' . URL . 'admin/add-category.php');
            }
        }
